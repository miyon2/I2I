...
#endif
#ifndef LIGHT_SPI_BUFF_SIZE
	#define LIGHT_SPI_BUFF_SIZE 3
#endif

//#define DEBUG

static const char *spi_device0 = "/dev/spidev0.0";
static const char *spi_device1 = "/dev/spidev0.1";
...
int transfer_light_data(int, uint8_t *, uint8_t *);
...
int read_light(int, uint8_t);
int read_light_mean(int, uint8_t, int);
int read_dust(int);
int spiDelay(int);
